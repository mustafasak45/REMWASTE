...
import com.opensource.utils.FindOS;
import java.time.Duration;
import java.util.stream.IntStream;

public class ActionMethods {

    Keys controlKey = FindOS.getOperationSystemName().equals("WINDOWS") ? Keys.CONTROL : Keys.COMMAND;
    WebDriver driver;
    ...
    public void sendKeysWithKey(Keys keyName){
